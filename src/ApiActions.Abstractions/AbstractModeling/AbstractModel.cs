...
namespace ApiActions.AbstractModeling
{
    public class AbstractModel : IEnumerable<AbstractModel>
    {
        ...
        private IDictionary<string, AbstractModel> Children =>
            _children ?? (_children = new Dictionary<string, AbstractModel>());
        ...
        public override string ToString()
        {
            ...
            if (_values != null && _values.Count > 1)
            {
                return string.Concat(Name, ": ",
                    _values.Select(v => v?.ToString()).Aggregate((a, b) => string.Concat(a, ",", b)));
            }
