...
namespace ApiActions.Swagger.Creation
{
    public class SwaggerApiActionRegistrationProvider : ISwaggerApiActionRegistrationProvider
    {
        ...
        private IReadOnlyCollection<Tuple<ApiActionVersion, ApiActionVersion, IApiActionRegistration>>
            _registrationPreCalcs;
        ...
        protected virtual IReadOnlyCollection<Tuple<ApiActionVersion, ApiActionVersion, IApiActionRegistration>>
