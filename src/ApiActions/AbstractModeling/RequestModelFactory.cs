...
namespace ApiActions.AbstractModeling
{
    public class RequestModelFactory : IRequestModelFactory
    {
        ...
        public RequestModelFactory(IConverterDelegateProvider converterDelegateProvider,
            ILogger<RequestModelFactory> log)
        {
            _converterDelegateProvider = converterDelegateProvider ??
                                         throw new ArgumentNullException(nameof(converterDelegateProvider));
