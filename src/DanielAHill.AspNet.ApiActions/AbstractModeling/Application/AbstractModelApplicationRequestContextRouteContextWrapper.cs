...
namespace DanielAHill.AspNet.ApiActions.AbstractModeling.Application
{
    internal class AbstractModelApplicationRequestContextRouteContextWrapper : IAbstractModelApplicationRequestContext
    {
        ...
        public IServiceProvider ApplicationServices { get { return _routeContext.HttpContext.ApplicationServices; } }
        ...
        public IReadableStringCollection Cookies { get { return _routeContext.HttpContext.Request.Cookies; } }
        ...
        public IReadableStringCollection Query { get { return _routeContext.HttpContext.Request.Query; }}
