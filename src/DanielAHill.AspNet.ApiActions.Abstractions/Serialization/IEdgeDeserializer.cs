...
{
    public interface IEdgeDeserializer
    {
        Task<AbstractModel> DeserializeAsync(IAbstractModelApplicationRequestContext context, CancellationToken cancellationToken);
    }
}